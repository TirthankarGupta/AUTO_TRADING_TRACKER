...
/* Remove container side padding so hero aligns with viewport */
...
/* HERO: start after sidebar, stretch across viewport (leave comfortable gap) */
.hero {
  position: relative;
  left: 300px;                        /* match sidebar width */
  width: calc(100vw - 340px);         /* viewport minus sidebar + gap */
  margin: 6px 20px 12px 20px;         /* keep a small gap from edges */
  border-radius:10px;
...
/* Sidebar widgets: make inputs white bg + black text */
...
/* Force visible selectbox selected text to black (broad selectors) */
...
/* FORCE selectbox text + dropdown items to black */
.stSidebar .stSelectbox div, 
.stSidebar .stSelectbox span, 
.stSidebar .stSelectbox * { color: #000000 !important; -webkit-text-fill-color: #000000 !important; }

/* FORCE button label text (Refresh) to black */
.stSidebar .stButton>button, 
.stSidebar .stButton>button *, 
.stSidebar button, 
.stSidebar button * { color: #000000 !important; -webkit-text-fill-color: #000000 !important; }
